...
public class ImageUtil {
    ...
    public static void loadImage(Context context, ImageView imageView, String uri) {
        if (!TextUtils.isEmpty(uri)) {
            ...
            Picasso.with(context).load(uri).error(R.drawable.placeholder).into(imageView);
        }
    }

    public static void loadResizedImage(Context context, ImageView imageView, String uri, int width, int height) {
        if (!TextUtils.isEmpty(uri)) {
    ...
    public static void loadResizedImage(Context context, ImageView imageView, int resourceId, int width, int height) {

        int widthDp = (int) pxFromDp(context, width);
        int heightDp = (int) pxFromDp(context, height);
        Picasso.with(context).load(resourceId).error(R.drawable.placeholder).resize(widthDp, heightDp).into(imageView);
    }
